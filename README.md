...
**Original PineTS source:** https://github.com/alaa-eddine/PineTS  
**Edited source:** https://github.com/EsIstJosh/PineTS

**Note:** PineTS related code is licensed separately using the AGPL3.0 license: [AGPL License](./AGPL_LICENSE)

Simple scripting capabilities similar to pinescript. See the [PineTS ReadMe](https://github.com/EsIstJosh/PineTS/blob/bd79b7f2d21d15f7470da118eab4f71638ce07da/README.md) for more information.
...
- **Trend Trace:** A transformable/scalable replica of a section of series between a drawing's points. Similar to 'Bars Pattern' in TradingView (instantiated from and linked to existing drawing: box, trendline, etc.)

### Indicators

*Implemented in TypeScript, from KLineChart primarily: https://github.com/klinecharts/KLineChart*
